...
(()=>{
 ...
 const mo=new MutationObserver(queueClean);document.addEventListener('DOMContentLoaded',()=>{cleanStray();try{mo.observe(document.body,{childList:true,subtree:true,characterData:true})}catch(_e){}});
